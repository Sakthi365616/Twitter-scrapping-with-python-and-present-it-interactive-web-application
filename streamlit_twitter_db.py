...
#****************************************************************************************************************************************#
#setting page and adding header and image
st.set_page_config(page_title='Twitter scrapping',layout='centered')
st.header('&emsp;&emsp;&emsp;&emsp;&emsp;**:blue[TWITTER SCRAPPING]**')
t_image=Image.open("C:/Users/shakt/OneDrive/Desktop/scrapping/Twitter-scraping.jpg.jpg")
st.image(t_image)
...
#****************************************************************************************************************************************#   
# Setting a header title with blue color for filter section 
